...
| 文档名称 | 大小 | 内容 |
|----------|------|------|
| **README.md** | 10KB | 项目介绍、技术栈、功能说明、API文档 |
| **ARCHITECTURE.md** | 17KB | 系统架构、技术选型、数据模型、核心设计 |
| **DEPLOY.md** | 7.7KB | 详细部署指南、环境配置、常见问题 |
| **API_TEST.md** | 7.9KB | 完整的API测试文档、示例代码 |
| **QUICKSTART.md** | 5.6KB | 5分钟快速启动指南 |
